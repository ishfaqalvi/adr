...
class ChemicalController extends Controller
{
    ...
    {
        $this->middleware('permission:chemicals-list',  ['only' => ['index']]);
        $this->middleware('permission:chemicals-view',  ['only' => ['show']]);
        $this->middleware('permission:chemicals-create',['only' => ['create','store']]);
        $this->middleware('permission:chemicals-edit',  ['only' => ['edit','update']]);
        $this->middleware('permission:chemicals-delete',['only' => ['destroy']]);
    }
